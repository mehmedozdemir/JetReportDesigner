...
const FN_GROUPS: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { insert: "log()", sig: "log(x, [base])", doc: "Natural log of x, or log base b when given." },
      { insert: "log10()", sig: "log10(x)", doc: "Base-10 logarithm." },
      { insert: "exp()", sig: "exp(x)", doc: "e raised to the power x." },
    ],
  },
  {
    id: "text",
    ...
    items: [
      ...
      { insert: "ltrim()", sig: "ltrim(s)", doc: "Remove leading spaces only." },
      { insert: "rtrim()", sig: "rtrim(s)", doc: "Remove trailing spaces only." },
      ...
      { insert: "startswith(, '')", sig: "startswith(s, prefix)", doc: "True if s starts with prefix (case-insensitive)." },
      { insert: "endswith(, '')", sig: "endswith(s, suffix)", doc: "True if s ends with suffix (case-insensitive)." },
      { insert: "indexof(, '')", sig: "indexof(s, sub)", doc: "0-based position of sub in s, or -1." },
      { insert: "padleft(, 5, '0')", sig: "padleft(s, len, [char])", doc: "Pad on the left to len characters (default space)." },
      { insert: "padright(, 5, ' ')", sig: "padright(s, len, [char])", doc: "Pad on the right to len characters (default space)." },
      { insert: "concat(, )", sig: "concat(a, b, …)", doc: "Join values into a single string, no separator." },
    ],
  },
  {
    id: "date",
    ...
    items: [
      ...
      { insert: "dayofweek()", sig: "dayofweek(d)", doc: "Day of week as a number: Sunday=0 … Saturday=6." },
      { insert: "adddays(, 7)", sig: "adddays(d, n)", doc: "Date n days after d." },
      { insert: "addmonths(, 1)", sig: "addmonths(d, n)", doc: "Date n months after d." },
      { insert: "addyears(, 1)", sig: "addyears(d, n)", doc: "Date n years after d." },
      { insert: "datediff('days', , )", sig: "datediff(unit, d1, d2)", doc: "Difference d2 − d1, in the given unit: days, hours, minutes, seconds, months or years." },
    ],
  },
  {
    id: "logic",
    ...
    items: [
      ...
      { insert: "switch(, '', , '')", sig: "switch(expr, case1, result1, …, [default])", doc: "First result whose case matches expr, else the trailing default (or null)." },
      { insert: "coalesce(, )", sig: "coalesce(a, b, …)", doc: "First non-null argument." },
      { insert: "isnull()", sig: "isnull(x)", doc: "True when x is null." },
      { insert: "nullif(, )", sig: "nullif(a, b)", doc: "Null when a equals b, otherwise a." },
      { insert: "format(, 'N2')", sig: "format(value, code)", doc: "Format a value with a .NET format string." },
      { insert: "tonumber()", sig: "tonumber(x)", doc: "Convert x to a number (0 if not parseable)." },
      { insert: "tostring()", sig: "tostring(x)", doc: "Convert x to text." },
      { insert: "toboolean()", sig: "toboolean(x)", doc: "Convert x to true/false." },
    ],
  },
];
